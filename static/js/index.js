...
(function dartProgram() {
  ...
  D = {
    _$RecipeFromJson: function(json) {
      var t1 = H._asInt(json.$index(0, "id")),
        t2 = H._asString(json.$index(0, "name")),
        t3 = J.map$1$1$ax(type$.List_dynamic._as(json.$index(0, "steps")), new D._$RecipeFromJson_closure(), type$.String);
      return new D.Recipe(t1, t2, P.List_List$of(t3, true, t3.$ti._eval$1("ListIterable.E")), H._asString(json.$index(0, "imageURL")), H._asString(json.$index(0, "originalURL")));
    },
    _$RecipeToJson: function(instance) {
      return P.LinkedHashMap_LinkedHashMap$_literal(["id", instance.id, "name", instance.name, "steps", instance.steps, "imageURL", instance.imageURL, "originalURL", instance.originalURL], type$.String, type$.dynamic);
    },
    Recipe: function Recipe(t0, t1, t2, t3, t4) {
      var _ = this;
      _.id = t0;
      _.name = t1;
      _.steps = t2;
    ...
    _$RecipeFromJson_closure: function _$RecipeFromJson_closure() {
    }
  },
  E = {
    main: function() {
      var t3, t4, t5, t6, t7, t8, t9, t10,
        t1 = document,
        t2 = t1.querySelector("#search-section");
      t2.toString;
      t3 = t1.querySelector("#search-bar");
      t3.toString;
      type$.InputElement._as(t3);
      t4 = t1.querySelector("#search-button");
      t4.toString;
      t5 = t1.querySelector("#recipe-not-found");
      t5.toString;
      t6 = t1.querySelector("#recipe-card");
      t6.toString;
      t7 = t1.querySelector("#recipe-title");
      t7.toString;
      t8 = t1.querySelector("#recipe-img");
      t8.toString;
      type$.ImageElement._as(t8);
      t9 = t1.querySelector("#recipe-directions");
      t9.toString;
      t1 = t1.querySelector("#recipe-button");
      t1.toString;
      type$.AnchorElement._as(t1);
      t4 = J.get$onClick$x(t4);
      t10 = t4.$ti;
      t2 = t10._eval$1("~(1)?")._as(new E.main_closure(t3, t6, t5, t7, t8, t9, t1, t2));
      type$.nullable_void_Function._as(null);
      W._EventStreamSubscription$(t4._target, t4._eventType, t2, false, t10._precomputed1);
    },
    main_closure: function main_closure(t0, t1, t2, t3, t4, t5, t6, t7) {
      var _ = this;
      _.searchBar = t0;
      _.recipeCard = t1;
      _.recipeNotFound = t2;
      _.recipeTitle = t3;
      _.recipeImage = t4;
      _.recipeDirections = t5;
      _.recipeButton = t6;
      _.searchSection = t7;
    },
    main__closure: function main__closure(t0) {
      this.recipeDirections = t0;
    }
  };
  var holders = [C, H, J, P, W, D, E];
  ...
  D.Recipe.prototype = {
    toJson$0: function() {
      var _this = this;
      return P.LinkedHashMap_LinkedHashMap$_literal(["id", _this.id, "name", _this.name, "steps", _this.steps, "imageURL", _this.imageURL, "originalURL", _this.originalURL], type$.String, type$.dynamic);
    },
    toString$0: function(_) {
      return C.C_JsonCodec.encode$2$toEncodable(D._$RecipeToJson(this), null);
    }
  };
  D._$RecipeFromJson_closure.prototype = {
    call$1: function(e) {
      return H._asString(e);
    },
    $signature: 20
  };
  E.main_closure.prototype = {
    ...
    $call$body$main_closure: function($event) {
      var $async$goto = 0,
        ...
        $async$self = this, response, recipe, t1;
      var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.searchBar.value;
              $async$goto = t1 != null ? 2 : 3;
              break;
            case 2:
              // then
              $async$goto = 4;
              return P._asyncAwait(W.HttpRequest_getString("http://localhost:8080/recipe?name=" + t1), $async$call$1);
            case 4:
              // returning from await.
              response = $async$result;
              if (response !== "Not found") {
                recipe = D._$RecipeFromJson(type$.Map_String_dynamic._as(C.C_JsonCodec.decode$2$reviver(0, response, null)));
                t1 = $async$self.recipeCard.style;
                t1.display = "block";
                t1 = $async$self.recipeNotFound.style;
                t1.display = "none";
                $async$self.recipeTitle.innerText = recipe.name;
                C.ImageElement_methods.set$src($async$self.recipeImage, recipe.imageURL);
                t1 = $async$self.recipeDirections;
                J.set$children$x(t1, H.setRuntimeTypeInfo([], type$.JSArray_Element));
                C.JSArray_methods.forEach$1(recipe.steps, new E.main__closure(t1));
                C.AnchorElement_methods.set$href($async$self.recipeButton, recipe.originalURL);
              } else {
                t1 = $async$self.recipeNotFound.style;
                t1.display = "block";
                t1 = $async$self.recipeCard.style;
              ...
              t1 = $async$self.searchSection.style;
              t1.height = "40%";
            case 3:
              // join
              // implicit return
  ...
  E.main__closure.prototype = {
    call$1: function(step) {
      var li;
      H._asString(step);
      li = type$.Element._as(W._ElementFactoryProvider_createElement_tag("li", null));
      li.innerText = step;
      J.get$children$x(this.recipeDirections).add$1(0, li);
    },
    $signature: 22
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString, W.EventTarget, W._CssStyleDeclaration_Interceptor_CssStyleDeclarationBase, W.DomException, W.Event, W._HtmlCollection_Interceptor_ListMixin, W._NodeList_Interceptor_ListMixin]);
    ...
    _inheritMany(W.HtmlElement, [W.AnchorElement, W.AreaElement, W.FormElement, W.ImageElement, W.InputElement, W.SelectElement]);
  ...
  var init = {
    ...
    metadata: [],
    types: ["~()", "~(~())", "@(@)", "Null(@)", "Null()", "~(Object?,Object?)", "@(@,String)", "@(String)", "Null(~())", "~(@)", "Null(@,StackTrace)", "~(int,@)", "~(Object[StackTrace?])", "Null(Object,StackTrace)", "_Future<@>(@)", "String(HttpRequest)", "~(ProgressEvent)", "~(Event)", "bool(Node)", "Element(Node)", "String(@)", "Future<~>(MouseEvent)", "~(String)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: typeof Symbol == "function" && typeof Symbol() == "symbol" ? Symbol("$ti") : "$ti"
  };
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"JavaScriptFunction":"JavaScriptObject","PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","_ResourceProgressEvent":"ProgressEvent","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","Window":"EventTarget","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JavaScriptObject":{"Function":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSDouble":{"num":[]},"JSString":{"String":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"]},"MappedIterator":{"Iterator":["2"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2"},"WhereIterable":{"Iterable":["1"]},"WhereIterator":{"Iterator":["1"]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"],"MapMixin.K":"1","MapMixin.V":"2"},"LinkedHashMapKeyIterable":{"Iterable":["1"]},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"AsyncError":{"Error":[]},"_AsyncCompleter":{"_Completer":["1"]},"_Future":{"Future":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"ListBase":{"ListMixin":["1"],"List":["1"],"Iterable":["1"]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"_JsonMap":{"MapMixin":["String","@"],"Map":["String","@"],"MapMixin.K":"String","MapMixin.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"Iterable":["String"],"ListIterable.E":"String"},"JsonUnsupportedObjectError":{"Error":[]},"JsonCyclicError":{"Error":[]},"JsonEncoder":{"Converter":["Object?","String"]},"JsonDecoder":{"Converter":["String","Object?"]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"StringBuffer":{"StringSink":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"_ChildrenElementList":{"ListMixin":["Element"],"List":["Element"],"Iterable":["Element"],"ListMixin.E":"Element"},"Element":{"Node":[],"EventTarget":[]},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListMixin.E":"Node","ImmutableListMixin.E":"Node"},"HttpRequest":{"EventTarget":[]},"HttpRequestEventTarget":{"EventTarget":[]},"ImageElement":{"Element":[],"Node":[],"EventTarget":[]},"InputElement":{"Element":[],"Node":[],"EventTarget":[]},"MouseEvent":{"Event":[]},"_ChildNodeListLazy":{"ListMixin":["Node"],"List":["Node"],"Iterable":["Node"],"ListMixin.E":"Node"},"Node":{"EventTarget":[]},"NodeList":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListMixin.E":"Node","ImmutableListMixin.E":"Node"},"ProgressEvent":{"Event":[]},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"UIEvent":{"Event":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]},"FixedSizeListIterator":{"Iterator":["1"]},"FilteredElementList":{"ListMixin":["Element"],"List":["Element"],"Iterable":["Element"],"ListMixin.E":"Element"},"SvgElement":{"Element":[],"Node":[],"EventTarget":[]}}'));
